...
func newComputer() *Computer {
	...
	return &Computer{pc: 0, halted: false, paused: false, memory: memory, debug: false}
}
...
func main() {
	...
	// fmt.Println("MEMORY BEFORE EXECUTION:")
	// comp.printMemoryRange(len(data))

	comp.executeProgram()

	// fmt.Println("MEMORY AFTER EXECUTION:")
	// comp.printMemoryRange(len(data))

	fmt.Printf("Value at position 0: %v\n", comp.readFromMemory(0, 0))
